...
<?php
/*
Template Name: Wallpaper 4K Paginated
*/
?>
...
<?php echo '<div class="galleries"> <a href="'.$url3.'" title="'.get_the_title().'">'.wp_get_attachment_image( get_the_ID(), 'thumbnail' ).'</a>'.'<div class="gallerytitle"><a href="'.get_permalink().'">'.$trunc_nfo.'</a></div>'; ?> 
